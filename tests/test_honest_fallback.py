...
when GROQ_API_KEY is missing — they must mark themselves as
rule_based_fallback / low-confidence instead of guessing."""
...
class HonestFallbackTests(unittest.TestCase):
    def setUp(self):
        self._env_patch = mock.patch.dict("os.environ", {"GROQ_API_KEY": ""}, clear=False)
