...
- Deneme 1: puan 61 — Zayıf merak bölümleri: Büyük Cevap., Riskli izlenme noktaları: 30s (İlk Kırılma), 60s (Final), 180s (Final)., Duygu eğrisi hedefi tutmuyor (4 bölümde)., OPENAI_API_KEY (ve GROQ_API_KEY) yok; kural tabanlı taslak yeniden denenerek iyileştirilemez.
...
İlk 3 saniye: ‘Bu Bitki Bir İmparatorluğun Kaderini Nasıl Değiştirdi?’ fikrinin en şaşırtıcı sonucunu göster ve cevabı verme. Cevabı birazdan göreceksiniz; ama önce bu sırrın başladığı yere dönelim.

### Köken — 0:30-1:00

Referans video açıklamasından ipucu: Yediğin şeyin içinde ne var? Kaynaklara göre, 🍓 Bugün marketlerden alıp severek tükettiğimiz o iri ve sulu çileklerin, aslında 1700'lerde Fransa Kralı için çalışan bir askeri casusun Şili'den… Bu tek başına bile hikâyenin yönünü değiştiriyor.
...
Bu Bitki Bir İmparatorluğun Kaderini Nasıl Değiştirdi?: İlk 3 saniye: ‘Bu Bitki Bir İmparatorluğun Kaderini Nasıl Değiştirdi?’ fikrinin en şaşırtıcı sonucunu göster ve cevabı verme.
